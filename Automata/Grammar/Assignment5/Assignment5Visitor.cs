...
public interface IAssignment5Visitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitDefaultParam([NotNull] Assignment5Parser.DefaultParamContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitParam([NotNull] Assignment5Parser.ParamContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFunctionAssignment([NotNull] Assignment5Parser.FunctionAssignmentContext context);
	/// <summary>
