...
public partial class Assignment5BaseListener : IAssignment5Listener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterDefaultParam([NotNull] Assignment5Parser.DefaultParamContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitDefaultParam([NotNull] Assignment5Parser.DefaultParamContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterParam([NotNull] Assignment5Parser.ParamContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitParam([NotNull] Assignment5Parser.ParamContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterInitialisation([NotNull] Assignment5Parser.InitialisationContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitInitialisation([NotNull] Assignment5Parser.InitialisationContext context) { }
	/// <summary>
