...
public partial class Assignment3BaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IAssignment3Visitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitLine([NotNull] Assignment3Parser.LineContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitFunctionCall([NotNull] Assignment3Parser.FunctionCallContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitKeyword([NotNull] Assignment3Parser.KeywordContext context) { return VisitChildren(context); }
}
} // namespace Grammar.Assignment3
